...
def long_inter(index):
    ...
    if (x["longitude"]>-73.93161 and x["longitude"]<-73.786210):  #and (x["latitude"]>40.798573 and x["latitude"]<-40.910320):
        return "BRONX"
...
#its obviously flawed since only longitude are used. But using geopy takes to much
# time for the execice.
#---------------------------------------------------------------------------------
...
df.drop(["borough","borough_deducing"],inplace=True,axis=1)
